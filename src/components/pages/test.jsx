  ...
  return (
    <>
      ...
      <Dialog open={openPontos} onClose={() => setOpenPontos(false)} fullWidth>
        ...
        <DialogContent>
          <Typography>Aqui você mostraria o grid diário/mensal de pontos desse funcionário.</Typography>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={openHoras} onClose={() => setOpenHoras(false)} fullWidth>
        ...
        <DialogContent>
          <Typography>Aqui você mostra o total de horas trabalhadas do mês.</Typography>
        </DialogContent>
      </Dialog>
    </>
  );
